            ...
            <div className={"card fluid"}>
              ...
              <div>
                ...
                {sNode.centrality && Object.keys(sNode.centrality).length > 1 && (
                  ...
                  <thead>
                    <tr>
                      <th><a href="https://reference.wolfram.com/language/ref/ClosenessCentrality.html">closness</a></th>
                      <th><a href="https://reference.wolfram.com/language/ref/DegreeCentrality.html">degree centrality</a></th>
                      <th><a href="http://mathworld.wolfram.com/GraphEccentricity.html">eccentricity</a></th>
                    </tr>
                  </thead>
                    <tbody>
                      <tr>
                        <td data-label="closeness">{sNode.centrality.closeness}</td>
                        <td data-label="degree">{sNode.centrality.degree}</td>
                        <td data-label="eccentricity">{sNode.centrality.eccentricity}</td>
                      </tr>
                    </tbody>
                  </table>
                  </div>
